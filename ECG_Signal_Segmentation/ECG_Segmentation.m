...
path = "C:\CIBER Lab\VetTrain\Data_Summer 2021\ACTIHEART\";

for count= 12 %1:length(Candidate)
    ...
    f1=FilenameDetect(path,CandidateCount,"ECG");
    disp(f1)
...
%     
%     f1=FilenameDetect(path,CandidateCount,"ECG_Baseline");
% 
...
%     
%     f1=FilenameDetect(path,CandidateCount,"ECG_Relaxation");
% 
...
%    
    ...
    f1=FilenameDetect(path,CandidateCount,"ECG_Interview");
